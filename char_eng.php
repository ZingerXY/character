...
<head>
	...
	<meta name="description" content="Character build calculator for Fallout Online: Requiem">
	<meta name="title" content="Character build calculator for Fallout Online: Requiem">
	<meta itemprop="name" content="Character build calculator for Fallout Online: Requiem">
	<meta property="og:title" content="Character build calculator for Fallout Online: Requiem">
	...
	<link rel="stylesheet" href="style_eng.css?ver=<?= $ver ?>">
	<script type="text/javascript" async src="js/jquery-3.1.0.min.js?ver=<?= $ver ?>"></script>
	<script async src="js/js.cookie.js?ver=<?= $ver ?>"></script>
	<script type="text/javascript" async src="js/text_eng.js?ver=<?= $ver ?>"></script>
...
<body>
	...
	<div id="main" class="main">
		...
		<div id="specialpointext" class="text reg shadow">SPECIAL.</div>
		...
		<div id="feat1" class="text2">
			<div id="life" class="resist res-2">Hitpoints</div>
			<div id="live" class="resist resnum0 res-2"></div>
			<div id="dadge" class="resist res-1">Evasion</div>
			<div id="dodge" class="resist resnum0 res-1"></div>
			<div id="anticrit" class="resist res0">Anticrit</div>
			<div id="acrit" class="resist resnum0 res0">0%</div>
			<div id="textnormal" class="resist res1">Normal</div>
			<div id="normal" class="resist resnum0 res1"></div>
			<div id="textlaser" class="resist res2">Laser</div>
			<div id="laser" class="resist resnum0 res2"></div>
			<div id="textfire" class="resist res3">Fire</div>
			<div id="fire" class="resist resnum0 res3"></div>
			<div id="textplasma" class="resist res4">Plasma</div>
			<div id="plasma" class="resist resnum0 res4"></div>
			<div id="textexplode" class="resist res5">Explosion</div>
			<div id="explode" class="resist resnum0 res5"></div>
			<div id="textelectro" class="resist res6">Electro</div>
		...
		<div id="feat2" class="text2">
			<div id="armorclass" class="text2 featop0">Armor class</div>
			<div id="armc" class="text2 featnum featop0"></div>
			<div id="actionpoint" class="text2 featop1">Action points</div>
			<div id="apoi" class="text2 featnum featop1"></div>
			<div id="maxload" class="text2 featop2">Carryweight</div>
			<div id="maxl" class="text2 featnum featop2"></div>
			<div id="meledmg" class="text2 featop3">Melee damage</div>
			<div id="mdmg" class="text2 featnum featop3"></div>
			<div id="overview" class="text2 featop4">Field of View</div>
			<div id="oview" class="text2 featnum featop4"></div>
			<div id="stabiltoxic" class="text2 featop5">Poison Res.</div>
			<div id="stox" class="text2 featnum featop5"></div>
			<div id="stabilradi" class="text2 featop6">Radiation Res.</div>
			<div id="srad" class="text2 featnum featop6"></div>
			<div id="procedure" class="text2 featop7">Sequence</div>
			<div id="proc" class="text2 featnum featop7"></div>
			<div id="levelhil" class="text2 featop8">Healing Rate</div>
			<div id="levh" class="text2 featnum featop8"></div>
			<div id="critrate" class="text2 featop9">Critical Chance</div>
		...
		<div id="createlistperk" class="text2">
			...
			<div id="fotterperk" class="text2">
				<center>
					<hr>
					<input id="search" name="perk" type="text" placeholder="Search perk">
					<!--a href="../message.php">Message author</a-->
				</center>
			</div>
			<div id="scrollupdown">
