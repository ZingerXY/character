...
var perk = {	//(перк, уровней перка, мин уровень взятия, максимальный уровень взятия, [требования])
	...
	PE_FASTER_HEALING: ["Быстрое лечение", "Вы получаете +15 к Уровню лечения, таким образом, ваши раны быстрее заживают. Восстановление 1/4 максимальных ОД при исцелении Санитаром. Использование препаратов на 200мс быстрей.",
		1, 6, 29,
		function () {pr.add("feats", "levh", stats.CHA[2]*3); },
		function () {pr.add("feats", "levh", -stats.CHA[2]*3); },
		{stats: {ENU: 8}}],
	...
	PE_NIGHT_VISION: ["Иммунитет", "У васс очень высокий иммунитет. Из конечного урона по вам вычитается величина вашей природной Силы.",
		1, 12, 29,
		function () {},
		function () {},
		{
	...
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +2 к трешхолдам, +5% к резистам Нормы и Огня.',
		1, 6, 29,
		function () {pr.addr("normal", 2, 5);pr.addr("fire", 2, 5); },
		function () {pr.addr("normal", -2, -5);pr.addr("fire", -2, -5); },
		{
			stats: {
				STR: 7
	...
	PE_STRONG_BACK: ["Переноска", "Прибавляет 100 кг к Максимальному весу и +50% к Атлетизму. Дает отдельный шанс 33% избежать опрокидывания.",
		1, 2, 29,
		function () {pr.add("feats", "maxl", 100);pr.add("skills", "speed", 50, 1); },
		function () {pr.add("feats", "maxl", -100);pr.add("skills", "speed", -50, 1); },
		{stats: {STR: 6, ENU: 6}}],
	PE_SHARPSHOOTER: ["Меткость", "Искусство попадать в цель с большого расстояния. +2 к восприятию если оно меньше 4. При определении дистанции вы получаете +2 к Восприятию и +6 к Дальности обзора.",
		1, 6, 29,
	...
	PE_SILENT_RUNNING: ["Бесшумный бег", "Теперь вы будете двигаться быстро, не издавая больше шума. Ранее это было совершенно неосуществимо в силу технических причин. Несовместим с уберперками.",
		1, 9, 29,
		function () {},
		function () {},
		{
	...
	PE_MASTER_TRADER: ["Торговля", "Вы стараетесь покупать товары по низким ценам, торгуясь до изнеможения. Вам даётся 25% скидка при покупке товаров.",
		...
		function () {},
		function () {},
		{skills: {trade: 200}}], // 200 опыта торговли
	...
	PE_SILENT_DEATH: ["Хитрость", "Вы хитры в своих действиях. +30 ОЖ, +5% к Увороту, +50% к Атлетизму.",
		1, 9, 29,
		function () {pr.add("feats", "live", 30);pr.add("feats", "dodge", 5);pr.add("skills", "speed", 50, 1); },
		function () {pr.add("feats", "live", -30);pr.add("feats", "dodge", -5);pr.add("skills", "speed", -50, 1); },
		{
			traits: {
	...
	PE_MASTER_THIEF: ["Вор-профессионал", "+40 Воровства и Взлом замков. У вас не ломаются отмычки при взломе. Регенерация в снике каждые 10 сек. Вы не выходите из скрытности при использовании навыков, атаке по вам или работы с инвентарем. При воровстве 200 можно открывать ящики монтировкой.",
		1, 9, 29,
	...
	PE_CULT_OF_PERSONALITY: ['Отличник', 'Вы отлично учились и многое усвоили. +5% к резистам от типов урона Плазма, Лазер, Электричество. Дает иммунитет к сжиганию ОД.',
		1, 6, 29,
		function () {pr.addr("laser", 0, 5);pr.addr("plasma", 0, 5);pr.addr("electro", 0, 5); },
		function () {pr.addr("laser", 0, -5);pr.addr("plasma", 0, -5);pr.addr("electro", 0, -5); },
		{
			stats: {
				PER: 7
	...
	PE_SCROUNGER: ["Полевой медик", "Вы обладаете огромными знаниями по медицине. +30% к навыку Санитар, +30% к навыку Доктор. +3 Удачи при лечении навыком Санитар. -2 сек. кд. санитара если вы лечите другого или другой вас. ",
		1, 9, 29,
		function () {pr.add("skills", "orderly", 30, 1);pr.add("skills", "doctor", 30, 1); },
		function () {pr.add("skills", "orderly", -30, 1);pr.add("skills", "doctor", -30, 1); },
	...
	PE_SCOUT: ["Скаут", "Увеличивает на одну клетку радиус трекинга и открытия черных клеток Глобальной Карты. Увеличивает шанс найти уникальную локацию.",
		...
		function () {},
		{stats: {ENU: 8}}],
	PE_MYSTERIOUS_STRANGER: ["Ветеран", "Жизненный опыт дает вам +30 ОЖ. Ваша меткость при прицельной атаке максимальная и каждое попадание вешает усталость на цель. +10 Класса Брони.",
		1, 12, 29,
		function () {pr.add("feats", "live", 30);pr.add("proc", "armc", 10);},
		function () {pr.add("feats", "live", -30);pr.add("proc", "armc", -10); },
		{stats: {LUC: 2}}],
	...
	PE_TARGETING: ["Стиляга", 'Стиль – ваше второе имя: вы выглядите неотразимо даже в лохмотьях, а вашим солнцезащитным очкам завидуют всё модники пустоши. Вы никогда не ловите эффект «Контузия» (белый экран). Скорость износа вашей брони замедляется в 4 раза. Иммунитет к черному экрану.',
		1, 2, 29,
		function () {},
		function () {},
		{stats: {CHA: 5}}],
	...
	PE_ATTACK: ["Неудержимый", "Вы неудержимы как... Да вас хрен остановишь! Вы получаете +ЛВ/2-1 ОД и +7% к регену ОД. +5 к конечному урону Уберперк.",
		1, 15, 29,
	...
	PE_RAGEBER: ['Ярость', 'Яростный удар валит противника на пол, добавляет 8 к урону и снимает 1 ОД. Кд удара 10 секунд. +10 к критроллу',
		...
		function () {},
		{skills: {melee: 200}}],
	PE_ARMOR: ['Броня', 'Ваше тело как броня. Вам добавлено 90 очков жизни, -5 к тикам огня, плазмы и яда.',
		1, 1, 1,
		function () {pr.add("feats", "live", 90); },
		function () {pr.add("feats", "live", -90); },
		{perks: {PE_LIFEGIVER: 1}, traits: {TRAIT_CHEM_RELIANT: 0}}],
	// << NEW PERK
	...
	PE_KAMA_SUTRA_MASTER: ["Спортсмен", "Занятия активными видами спорта не прошли даром. Вы получаете +45 Очков жизней и +20 к Классу Брони.",
		1, 12, 29,
		function () {pr.add("feats", "live", 45);pr.add("feats", "armc", 20); },
		function () {pr.add("feats", "live", -45);pr.add("feats", "armc", -20); },
		{stats: {STR: 8}}],
	...
	PE_EXPERT_EXCREMENT: ["Спец по уборке экскрементов", "Вы научились убирать дерьмо за браминами лучше, чем кто-либо.",
		...
		{}],
	// NEW PERK >>
	PE_EXPERT_MEDIC: ["Опытный медик", "При лечении санитара минимум лечения берется как среднее значение первоначального максимума и минимума лечения. Полный отхил союзника.",
		1, 6, 29,
		function () {},
		function () {},
		{skills: {doctor: 80}}],
	...
	PE_JINXED_II: ["Старый вояка", "На своём веку вы повидали многое, и вас так просто не сломить. +32% к антикриту.",
		1, 12, 29,
		function () {pr.add("feats", "acrit", 32);},
		function () {pr.add("feats", "acrit", -32);},
		{perks: {PE_TERMINATOR: 1}}],
	...
	PE_NAPROLOM: ["Бывалый", "Вы знаток оружия. +7% к навыку Легкое, Тяжелое, Энергетическое оружие.",
		1, 12, 32,
		function () {pr.add("skills", "light", 7, 1);pr.add("skills", "heavy", 7, 1);pr.add("skills", "energy", 7, 1); },
		function () {pr.add("skills", "light", -7, 1);pr.add("skills", "heavy", -7, 1);pr.add("skills", "energy", -7, 1); },
		{stats: {INT: 6}}],
	...
	PE_FIRESHOOT: ['Прищур', 'Вы получаете 10% к шансу на крит, восстановление 1 од при прицельном выстреле.',
		1, 9, 29,
		function () {
	...
	PE_DERMAL_IMPACT: ["Живчик", "Вы имеете повышенную живучесть (+40 ОЖ) и природное лечение (+15 к Уровню лечения).",
		1, 12, 29,
		function () {pr.add("feats", "live", 40);pr.add("feats", "levh", stats.CHA[2]*3); },
		function () {pr.add("feats", "live", -40);pr.add("feats", "levh", -stats.CHA[2]*3); },
		{
			stats: {
				ENU: 6
	...
	PE_COMBAT_ENGINEER: ["Боевой Инженер", "Вы настолько преуспели в инженерном деле, что теперь можете применять эти навыки в бою. Вы получаете +20% к навыку Ремонт и вам доступны особые виды вооружения.",
		...
		function () {pr.add("skills", "repair", -20, 1); },
		{stats: {PER: 6, INT: 6, AGI: 3}, skills: {repair: 180}}],
