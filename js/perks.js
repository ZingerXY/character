...
var perk = {	//(перк, уровней перка, мин уровень взятия, максимальный уровень взятия, [требования])
	...
	PE_RAD_RESISTANCE: ["Уст. к радиации", "Вы лучше переносите сильное воздействие радиации на организм. Каждый уровень этой способности добавляет +15% к Устойчивости к радиации.",
		...
		function(){pr.add("feats","srad",-15);},
        {stats:{ENU:6,INT:4}}],
	PE_TOUGHNESS: ["Крутизна", "Крутизна позволяет чувствовать себя под защитой. За каждый уровень этой способности вы получаете +8% к Резисту от огня, взрыва и Сопротивляемость урона от нормы на 2 единицы.",
		1,6,29,function(n){return !checkperk("PE_MENTAL_BLOCK") && stats.ENU[2] >= 6 && stats.STR[2] >= 8;},
		function(){pr.addr("normal",2,0);pr.addr("fire",0,8);pr.addr("explode",0,8);},
		function(){pr.addr("normal",-2,-0);pr.addr("fire",0,-8);pr.addr("explode",0,-8);},
	...
	PE_SILENT_RUNNING: ["Бесшумный бег", "Теперь вы будете двигаться быстро, не издавая больше шума. Ранее это было совершенно неосуществимо в силу технических причин. Несовместим с перком - Снайпер.",
		1,12,29,function(n){return !checkperk("PE_ATTACK") && !checkperk("PE_SNIPER") && stats.AGI[2] >= 7 && (n||skills.sneak[0]>=150) && !("TRAIT_SKILLED" in mychar.traits) && !("TRAIT_HEAVY_HANDED" in mychar.traits);},
		function(){},
		function(){},
        {stats:{AGI:7},skills:{sneak:150},perks:{PE_SNIPER:1,PE_ATTACK:1},traits:{TRAIT_SKILLED:1,TRAIT_HEAVY_HANDED:1}}],
	...
	PE_ATTACK: ["Неудержимый", "Вы неудержимы. Получаете +очков действия и +атлетизм к урону согласно вашей Ловкости и Восприятию. Нельзя взять Снайпера, Терма и Человека Действия.",
