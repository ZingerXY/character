...
var perk = {	//(перк, уровней перка, мин уровень взятия, максимальный уровень взятия, [требования])
	...
	PE_BIGSKIN: ["Толстокожий", "От типов урона Норма, Плазма, Электро вы получаете на 15% меньше повреждений. Исключает Железного человека.",
		...
		function () {},
		function () {},
		{skills: {ranger: 220}, perks: {PE_STOIK: 1}}],
	...
	PE_FISTRAGE: ["Критическое мышление", "Каждый выстрел увеличивает на 10% критшанс вплоть до 30%. После выпадении крита он обнуляется.",
		...
		function () {},
		function () {},
		{perks:{PE_SNIPER: 1, PE_SILENT_RUNNING: 1}}],
	...
	PE_ADRENALINE_RUSH: ['Кровопийца', 'Обстоятельно изучив кровь, вы получаете +20 ОЖ. Также каждая атака по цели восстановит (ВС*2) Очков здоровья. При использовании навыка Санитар, вы снимаете с себя эффект Нагрева.',
		...
		function () {pr.add("feats", "live", 20); },
		function () {pr.add("feats", "live", -20); },
		{skills:{orderly: 200}, stats: {ENU: 7}}],
	...
	PE_NAPROLOM: ["Бывалый", "Вы знаток оружия. +7% к навыку Легкое, Тяжелое, Энергетическое оружие.",
		1, 12, 32,
		function () {pr.add("skills", "light", 40, 1);pr.add("skills", "heavy", 40, 1);pr.add("skills", "energy", 40, 1); },
		function () {pr.add("skills", "light", -40, 1);pr.add("skills", "heavy", -40, 1);pr.add("skills", "energy", -40, 1); },
		{stats: {INT: 6}}],
	...
	PE_FISTSANITAR: ['Военврач', 'Лечение Санитаром как при 10 Удачи. С шансом (11-ХаризмаПротивника) вешает эффект Вялость при атаке (только одиночным выстрелом или ударом).',
		...
		function () {},
		function () {},
		{stats: {INT: 10, LUC: 3}, skills: {doctor: 230}}],
