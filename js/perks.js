...
var perk = {	//(перк, уровней перка, мин уровень взятия, максимальный уровень взятия, [требования])
	...
	PE_TOUGHNESS: ["Крутизна", "Крутизна позволяет чувствовать себя под защитой. Вы получаете +2 Трешхолда от нормы, +8% к Резисту от Огня и Взрыва. ",
		1,6,29,function(n){return !checkperk("PE_MENTAL_BLOCK") && stats.ENU[2] >= 6 && stats.STR[2] >= 8;},
    ...
    PE_CULT_OF_PERSONALITY: ["Отличник", "За каждый уровень этой способности вы получаете +6% к Резисту от лазера, плазмы, и +8% от электричества.",
		1,2,29,function(n){return !checkperk("PE_MENTAL_BLOCK") && stats.PER[2] >= 7 && stats.INT[2] >= 8},
	...
	PE_BOOKWORM: ["Регенерация", "Пассивное восстановление ОЖ в режиме боя. Тик регенерации 10 секунд. При использовании доктора дает бонус +100 к навыку. +20 Уровень лечения.",
		1,15,29,function(n){return stats.CHA[2] >= 5 && stats.INT[2] >= 6},
		function(){pr.add("feats","levh",20);},
		function(){pr.add("feats","levh",-20);},
        {stats:{CHA:5,INT:6}}],
	...
	PE_LIGHT_STEP: ["Легкие шаги", "Вы ловки, удачливы и всегда настороже. 50%, что ловушка на вас сработает. Урон от ловушек снижен на 25%. +15% к Резисту от Взрыва, +5 к Трешхолду Огня.",
		1,6,29,function(n){return stats.AGI[2] >= 5;},
    ...
    PE_STONEWALL: ["Человек-глыба", "+50% шанс игнорировать опрокидывание, +5 Трешхолда от Взрыва.",
		1,2,29,function(n){return stats.STR[2] >= 6;},
    ...
    PE_PRO_UDAR: ["Токсиколог", "Вы достигли небывалых высот в химии. Любое ваше оружие наносит дополнительный урон отравлением.",
		1,9,29,function(n){return (n||skills.science[0] >= 240);},
		function(){},
		function(){},
        {skills:{science:240}}],
