...
var perk = {	//(перк, уровней перка, мин уровень взятия, максимальный уровень взятия, [требования])
	...
	PE_RAD_RESISTANCE: ["Уст. к радиации", "Вы лучше переносите сильное воздействие радиации на организм. Каждый уровень этой способности добавляет +10% к Устойчивости к радиации.",
		1, 32, 99,
		function () {pr.add("feats", "srad", 20); },
		function () {pr.add("feats", "srad", -20); },
		{stats: {ENU: 6, INT: 4}}],
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +2 к трешхолдам трешхолдам Нормы и Лазера.',
		1, 6, 29,
	...
	PE_SNIPER: ['Снайпер', 'Шанс нанести Крит увеличивается на 40%. -1 ОД на прицельный выстрел.',
		1, 15, 29,
		function () {pr.add("feats", "crit", stats.LUC[2]*6); },
		function () {pr.add("feats", "crit", -stats.LUC[2]*6); },
		{
			traits: {
				TRAIT_GOOD_NATURED: 1,
	...
	PE_FRIENDLY_FOE: ["Фанат дробовиков", "Вас с детства тянет к дробовикам (+30% к Легкому оружию, +20% к Ремонту). При выстреле с дробовика, при очереди, добавляется +4 к каждой пуле, при одиночном +10 к конечному урону.",
		...
		function () {pr.add("skills", "light", -30, 1);pr.add("skills", "repair", -20, 1); },
		{stats: {INT: 6}, skills: {light: 160},			traits: {
				TRAIT_GOOD_NATURED: 1,
				TRAIT_HEAVY_HANDED: 1
			}
		}],
	...
	PE_FISTRAGE: ["Критическое мышление", "Каждый выстрел увеличивает на 10% критшанс вплоть до 30%. После выпадении крита он обнуляется.",
		...
		function () {},
		function () {},
		{perks:{PE_SNIPER: 1, PE_FIRESHOOT: 1}}],
	...
	PE_GAMBLER: ["Атлет", "Быстрее! Выше! Сильнее! Усиленные тренировки не проходят даром. +50% к навыку Атлетизм. -2 секунды выхода из боя.",
		1, 6, 29,
		function () {pr.add("skills", "speed", 75, 1); },
		function () {pr.add("skills", "speed", -75, 1); },
		{skills: {speed: 50}}],
	...
	// pre 34: исключает умельца но не добродуша. хаха.
	...
	PE_FIRESHOOT: ['Прищур', 'Вы получаете 15% к шансу на крит, восстановление 1 од при прицельном выстреле.',
		1, 9, 29,
		function () {
