...
var perk = {	//(перк, уровней перка, мин уровень взятия, максимальный уровень взятия, [требования])
	...
	PE_FASTER_HEALING: ["Быстрое лечение", "Вы получаете +15 к Уровню лечения, таким образом, ваши раны быстрее заживают. Восстановление 1/4 максимальных ОД при исцелении Санитаром. Использование препаратов на 200мс быстрей.",
		1, 6, 29,
		function () {pr.add("feats", "levh",7); },
		function () {pr.add("feats", "levh", -7); },
		{stats: {ENU: 8}}],
		// pre 33: Быстрое лечение +5 УЛ
	...
	PE_RAD_RESISTANCE: ["Уст. к радиации", "Вы лучше переносите сильное воздействие радиации на организм. Каждый уровень этой способности добавляет +10% к Устойчивости к радиации.",
		...
		function () {pr.add("feats", "srad", -10); },
		{stats: {ENU: 6, INT: 4}}],
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +3 к трешхолдам трешхолдам Нормы и Лазера.',
		1, 6, 29,
		function () {pr.addr("normal", 3, 0);pr.addr("laser", 3, 0); },
		function () {pr.addr("normal", -3, 0);pr.addr("laser", -3, 0); },
		{
			stats: {
				STR: 8
		...
		// pre 33  Вы получаете +3 к трешхолдам Нормы и Лазера.
	...
	PE_SILENT_RUNNING: ["Бесшумный бег", "Теперь вы будете двигаться быстро, не издавая больше шума. Бег в скрытности. ",
		1, 9, 29,
		function () {},
		function () {},
		{}],
	...
	PE_SPEAKER: ["Болтливость", "Болтун - находка для врага! С каждым уровнем этой способности вы получаете +10% к навыку Красноречие.",
		...
		function () {pr.add("skills", "oratory", -10, 1); },
		{stats: {INT: 4}}],
	PE_HEAVE_HO: ['Эволюция', 'Если попавший в вас игрок имеет больше жизней и у вас нет кд Доктора, вы получаете 1 Од и +2 сек кд дока-, если этот игрок у вас не в Стеке. .',
		1, 6, 29,
		function () {},
		function () {},
		{
	...
	PE_HARD: ["Закалка", "Ваш организм подготовлен к быстрому лечению в сложных условиях. С каждым уровнем этой способности ваш Уровень лечения возрастает на 3 единиц.",
		1, 32, 99,
	...
	PE_ARMOR: ['Оборотень', 'Если по вам стреляет игрок не из вашего Стека то он наносит на 4 повреждения меньше. Если же вы стреляете по игроку, у которого вы в Стеке, вы наносите на 5 повреждения больше.',
		...
		function () {},
		{stats: {CHA: 2}}],
	// << NEW PERK pre 33 : помещён на 12 уровень
	...
	PE_JINXED_II: ["Старый вояка", "На своём веку вы повидали многое, и вас так просто не сломить. +32% к антикриту.",
		1, 12, 29,
		function () {pr.add("feats", "acrit", 20);},
		function () {pr.add("feats", "acrit", -20);},	
		{
			traits: {
				TRAIT_SKILLED: 1
	...
	// pre 33: теперь исключает умельца
	...
	PE_DERMAL_IMPACT: ["Живчик", "Вы имеете повышенную живучесть (+35 ОЖ) и природное лечение (+10 к Уровню лечения).",
		1, 12, 29,
		function () {pr.add("feats", "live", 35);pr.add("feats", "levh", 10); },
		function () {pr.add("feats", "live", -35);pr.add("feats", "levh", -10); },
		{
			stats: {
				ENU: 6
