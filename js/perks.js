...
var perk = {	//(перк, уровней перка, мин уровень взятия, максимальный уровень взятия, [требования])
	...
	PE_TOUGHNESS: ["Крутизна", "Крутизна позволяет чувствовать себя под защитой. Вы получаете +2 Трешхолда от нормы, +8% к Резисту от Огня и Взрыва. ",
		...
		function(){pr.addr("normal",0,5);pr.addr("fire",0,10);pr.addr("explode",0,10);},
		function(){pr.addr("normal",0,-5);pr.addr("fire",0,-10);pr.addr("explode",0,-10);},
    ...
    PE_FORTUNE_FINDER: ["Воодушевление", "Каждый Уворот от вражеской атаки прибавляет вам жизненной энергии (+40 к Очкам жизней) и активности (+1 ОД).",
		...
		function(){pr.add("feats","live",stats.CHA[2]*5);},
		function(){pr.add("feats","live",-stats.CHA[2]*5);},
        {stats:{AGI:7,PER:6}}],
	...
	PE_MASTER_THIEF: ["Вор-профессионал", "+40 Воровства и Взлом замков. У вас не ломаются отмычки при взломе. Регенерация в снике каждые 10 сек. При воровстве 200 можно открывать ящики монтировкой.",
		1,9,29,function(n){return (n||skills.steal[0] >= 100 && skills.hack[0] >= 60);},
		function(){pr.add("skills","steal",40,1);pr.add("skills","hack",40,1);},
		function(){pr.add("skills","steal",-40,1);pr.add("skills","hack",-40,1);},
        {skills:{steal:100,hack:60}}],
