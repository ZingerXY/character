...
var perk = {	//(перк, уровней перка, мин уровень взятия, максимальный уровень взятия, [требования])
	...
	PE_SILENT_RUNNING: ["Бесшумный бег", "Теперь вы будете двигаться быстро, не издавая больше шума. Ранее это было совершенно неосуществимо в силу технических причин. Несовместим с перком - Снайпер.",
		...
		function(){},
		function(){},
        {stats:{AGI:7},skills:{sneak:150},perks:{PE_ADW_MET:1,PE_SNIPER:1}}],
	...
	PE_ATTACK: ["Неудержимый", "Вы неудержимы. Получаете +4 Од и +10% к урону. Нельзя взять Снайпера, Терма, Человека действия.", // 10% к урону А
		1,15,29,function(n){return !checkperk("PE_ACTION_BOY") && !checkperk("PE_SNIPER") && !checkperk("PE_TERMINATOR") && !("TRAIT_SKILLED" in mychar.traits);}, 
		function(){pr.add("feats","apoi",4);}, 
		function(){pr.add("feats","apoi",-4);},
        {perks:{PE_ACTION_BOY:1,PE_SNIPER:1,PE_TERMINATOR:1},traits:{TRAIT_SKILLED:1}}],
