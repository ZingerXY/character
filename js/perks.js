...
var perk = {	//(перк, уровней перка, мин уровень взятия, максимальный уровень взятия, [требования])
    ...
    PE_MENTAL_BLOCK: ["Стойкость", "Вы очень сильны и устойчивы. Вы получаете 3% к норме и +5% ко остальным Резистам. Нельзя взять Отличника или Крутизну.",
		...
		function(){for(i in resist)pr.addr(i,0,5);pr.addr("normal",0,-2);},
		function(){for(i in resist)pr.addr(i,0,-5);pr.addr("normal",0,2);},
	...
	PE_LIGHT_STEP: ["Легкие шаги", "Вы ловки, удачливы и всегда настороже. 25%, что ловушка на вас сработает. Резист к взрыву увеличен на +15%, трешхолд огня 5. 50% избежать нокдауна.",
		1,12,29,function(n){return stats.AGI[2] >= 5;},
	...
	PE_IRON_MAN: ["Железный человек", "С этой способностью Вы получаете гораздо меньше урона.",
		...
		function(){},
        {}],    
    PE_PRO_UDAR: ["Весельчак", "Вы не падаете при употреблении алкоголя, а наоборот получаете бонус к защите -10%.",
		1,6,29,function(n){return stats.CHA[2] >= 6},
		function(){},
		function(){},
        {stats:{CHA:6}}],
