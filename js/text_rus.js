...
var classes = {
	...
	2: ["Пулеметчик", "Встроенный Бонус точности.<br>Нельзя брать перки на очки действия."],
	3: ["Берсерк", "Встроенный Рикошет и Дробила.<br>Точность в стрельбе - 5%."],
	...
	8: ["Пироман", "Встроенный перк Пироманьяк. Иммунитет к тикам огня.<br>Нельзя брать перки на очки действия."],
	length: 8,
}
...
var texttraits = {
	TRAIT_FAST_METABOLISM: ['Быстрый метаболизм', 'Ваш метаболизм превышает норму. Вам дается +15 к уровню лечения, +15 к силе исцеления суперстимпаков. Устойчивость к яду и радиации в 2 раза меньше.'],
...
var textperk = {
	...
	PE_DERMAL_IMPACT: ['Живчик', 'Вы имеете повышенную живучесть (+40 ОЖ) и природное лечение (+15 к Уровню лечения).'],
