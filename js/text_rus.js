...
var texttraits = {
	...
	TRAIT_CHEM_RELIANT: ['Химик', '-5 к тикам плазмы, огня. Двойное действие шприцов и психо. Длительность наркотиков меньше в 2 раза. Откаты длятся 30 секунд. Шанс получить зависимость увеличен в 2 раза. Зависимость длятся в 3 раза дольше.'],
...
var textperk = {
	...
	PE_BONUS_RANGED_DAMAGE: ['Бонус точности', 'Ваши тренировки в обращении со стрелковым оружием сделали свое дело. Выстрелы очередью наносят больше урона +(кол-во пуль*3). '],
	...
	PE_HTH_EVADE: ['Верткость', 'Вы чувствуете, когда надо дернуться с места, природная ловкость помогает вам в этом. Процент Уклонения от атаки увеличивается на Максимальные Очки Действия.'],
	...
	PE_FIRESHOOT: ['Прищур', 'Вы получаете 15% к шансу на крит'],
	// << NEW PERK
