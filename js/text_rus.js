...
var texttraits = {
	TRAIT_FAST_METABOLISM: ['Быстрый метаболизм', 'Ваш метаболизм превышает норму. Вам дается +15 к уровню лечения, +3 к силе исцеления суперстимпаков. Устойчивость к яду и радиации в 2 раза меньше. Любое применение навыков добавит вам 1 жизнь'],
	TRAIT_BRUISER: ['Крушила', '+3 к Силе, +25 к Рукопашным повреждениям. Минусы: -1 ОД, нельзя тагнуть легкое, тяжелое или энерго оружие'],
	...
	TRAIT_ONE_HANDER: ['Однорукий', 'Вы отлично стреляете из любого одноручного оружия (+60 к навыку при расчетах, +10 к урону и игнорирование штрафа на силу). С двуручным же есть проблемы (-40 к навыку при расчетах).'],
	...
	TRAIT_HEAVY_HANDED: ['Вор', ' +25 к Уровню лечения. Холодное одноручное оружие и метательные ножи наносят +10 конечного урона, но точность другого оружия равна 5%. Бонусы для вора. Вы не можете наносить критические удары.'],
	...
	TRAIT_BLOODY_MESS: ['Маньяк', 'Вы получаете +125 к Атлетизму. При убийстве игрока вы выходите из боя и получаете бег в бою - 3 секунды. Износ вашей брони и оружия увеличен в два раза.'],
	TRAIT_JINXED: ['Дурной глаз', 'Повышенный шанс критического промаха у вас и ваших жертв. -25 хп у атаковавшего вас игрока, -25 хп если вы атаковали кого-то. (промах считается) У вас есть 5% шанса, что санитар или СС возымеют двойное действие. 5% шанс что СС не сработает совсем.'],
	TRAIT_GOOD_NATURED: ['Добродушие', 'Боевые навыки меньше, а мирные-больше. Вы берете перки каждые 2 уровня, но не можете взять уберперки и Дробилу. Ваш уворот делится пополам. Большинство гуманоидов вас не атакуют, но звери атакуют без задержки.'],
	TRAIT_CHEM_RELIANT: ['Химик', '+30 ХП, -5 к тикам плазмы и огня, имун к тикам яда. Длительность наркотиков увеличена в 3 раза. Откаты длятся 30 секунд. Шанс получить зависимость увеличен в 2 раза. Зависимость длятся в 3 раза дольше.'],
...
var textperk = {
	...
	PE_FASTER_HEALING: ['Быстрое лечение', 'Вы получаете + (Харизма * 3) к Уровню лечения, таким образом, ваши раны быстрее заживают. Восстановление 4 ОД при исцелении Санитаром. Использование препаратов на 200мс быстрей.'],
	...
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +2 к трешхолдам Нормы, Лазера и Огня'],
	...
	PE_SNIPER: ['Снайпер', 'Шанс нанести Крит увеличивается на 40%. -1 ОД на прицельный выстрел. +10 урона если прошел крит у вас и антикрит у цели'],
	...
	PE_HEAVE_HO: ['Эволюция', 'Если попавший в вас игрок имеет больше жизней и у вас нет кд Доктора, вы получаете 1 Од и +2 сек кд доктора, если этот игрок у вас не в Стеке.  '],
	...
	PE_FLOWER_CHILD: ['Полевой санитар', 'Восстановление навыка Санитар меньше на 4 секунды. При лечении санитаром добавляются (ИН+УД)*5 дополнительные ОЖ'],
	...
	PE_MYSTERIOUS_STRANGER: ['Ветеран', 'Жизненный опыт дает вам +30 ОЖ. Ваша меткость при прицельной атаке максимальная и каждое попадание вешает усталость на цель. В защите вы имеете +8 Класса Брони.'],
	...
	// << NEW PERK
	PE_ADRENALINE_RUSH: ['Кровопийца', 'Обстоятельно изучив кровь, вы получаете +25 ОЖ. Также каждая атака по цели восстановит (ВС+4) Очков здоровья. При использовании навыка Санитар, вы снимаете с себя эффект Нагрева.'],
	...
	// << NEW PERK
	PE_JINXED_II: ['Старый вояка', 'На своём веку вы повидали многое, и вас так просто не сломить. +20% к антикриту.'],
