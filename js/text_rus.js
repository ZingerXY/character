...
var textperk = {
	...
	PE_HEALER: ['Лечение', 'Вы получаете +40 ОЖ бонуса при использовании санитара, и +20 дополнительное если в доп. слоте есть сумка парамедика. +20 к лечению товарища санитаром или наоборот.'],
	...
	PE_FLOWER_CHILD: ['Полевой санитар', 'Восстановление навыка Санитар меньше на 4 секунды. При лечении санитаром добавляются (ИН+УД)*3 дополнительные ОЖ, а также можно восстановить все ОЖ с шансом (Удача*2).'],
	...
	PE_FISTRAGE: ["Критическое мышление", "Каждый выстрел увеличивает на Удача% критшанс вплоть до 25%. После выпадении крита он возвращается до значения Удачи."],
