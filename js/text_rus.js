...
var texttraits = {
	...
	TRAIT_BLOODY_MESS: ['Маньяк', 'Выход из боя при убийстве игрока. Восстановление 6 ОД при убийстве игрока. Восстановление 3 ОД при убийстве НПС. Ваша броня и броня ваших жертв ломается в два раза быстрее и в два раза больше поломок при смерти. Ваше оружие изнашивается в два раза быстрее'],
	...
	TRAIT_GOOD_NATURED: ['Добродушие', 'Ваши боевые навыки меньше, зато мирные - больше. Вы берете перки каждые 2 уровня. Вы не можете взять перки на регенерацию, нанесение и поглощение урона. Большинство гуманоидов вас не атакуют.'],
	...
	TRAIT_SEX_APPEAL: ['Жидкое тело', 'ВВы получаете -20% на сопротивление очередям и типу урона Огонь, увеличение вашего Максимального веса на 50 кг. Лечащие препараты и санитар не действуют в полную мощь (-20% при лечении).'],
	TRAIT_SKILLED: ['Умелец', 'Параметры персонажа улучшены (+2 ВН, ОБ, ИН, ЛВ, +15% антикрита, +15% к шансу крита). Но вы получаете новые перки каждый четвертый уровень, а не третий. Нельзя взять уберперки.'],
