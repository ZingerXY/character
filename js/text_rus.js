...
var texttraits = {
	...
	TRAIT_JINXED: ['Дурной глаз', 'Повышенный шанс критического промаха у вас и ваших жертв. 50% шанса, что рана, которую накладывают на вас, по итогу не наложится на вас, а отразится на противника и что ваш уворот превратится в промах противника.  У вас есть 5% шанса, что санитар или СС возымеют двойное действие'],
	...
	TRAIT_NIGHT_PERSON: ['Импульсивный', 'Вы очень активны, и это добавляет вам 2 ОД и 30% шанс восстановить 1 ОД при перезарядке, но вы получаете на 2 Очков Умений меньше за каждый уровень. Также +20% к Метательному. Восстановление ОД во время бега и ходьбы на 25% быстрее.']
}
...
var textperk = {
	...
	PE_DEFENCE: ['Рефлексы', 'Ваши рефлексы повышены и не прицельно вы стреляете быстрее. -1 ОД на неприцельный выстрел (кроме инженерного). Нельзя взять Снайпера и Быстрого стрелка.'],
	...
	PE_LUCKDOC: ["Флаг удачи", "С вероятностью Удача% * 1.5% книга даст двойной эффект, а тик регена может дать 99 очков жизней, если вы не на глобальной карте."],
	...
	// NEW PERK >>
	PE_KEEN: ["Зоркий", " Режется штраф дыма (60-дистанция)/2. В случае выстрела очередью игнор дыма."],
