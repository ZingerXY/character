...
var texttraits = {
	TRAIT_FAST_METABOLISM: ['Быстрый метаболизм', 'Ваш метаболизм превышает норму. Вам дается +5 к уровню лечения, +3 к силе исцеления суперстимпаков. Устойчивость к яду и радиации в 2 раза меньше.'],
...
var textperk = {
	...
	PE_FASTER_HEALING: ['Быстрое лечение', 'Вы получаете +7 к Уровню лечения, таким образом, ваши раны быстрее заживают. Восстановление 4 ОД при исцелении Санитаром. Использование препаратов на 200мс быстрей.'],
	...
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +3 к трешхолдам Нормы, Лазера'],
	...
	PE_BOOKWORM: ['Регенерация', '+45 к Уровню лечения. Лечит конечности во время тика раз в 10 секунд, если персонаж не в бою.'],
	...
	PE_STONEWALL: ['Человек-глыба', 'Первая тычка вводящая в бой наносит вдвое меньше урона. Не действует на погекс. 60% шанс игнорировать опрокидывание, Не может выронить оружие/нельзя выбить оружие'],
