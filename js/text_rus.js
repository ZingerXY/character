...
var textperk = {
    ...
    PE_FORTUNE_FINDER: ['Воодушевление', 'Каждый Уворот от вражеской атаки прибавляет вам 5*Харизма ОЖ и +1 ОД. Если ОЖ меньше трети от максимума, вы не получаете криты.'],
	...
	PE_SNIPER: ['Снайпер', 'Любое попадание в цель из оружия может стать Критическим ударом. Шанс нанести Крит. урон по формуле (УД*3). -1 ОД на прицельный выстрел.'],
