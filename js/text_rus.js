...
var textperk = {
	...
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +7% к Резисту от нормы, огня, взрыва и Сопротивляемость урона от нормы на 1 единицу.'],
	...
	PE_ATTACK: ['Неудержимый', 'Вы неудержимы. Получаете +Очков действия (ЛВ/2) и +процент к урону согласно вашей Ловкости. Нельзя взять Снайпера, Терминатора и Человека Действия.'],
    ...
    PE_STONEWALL: ['Человек-глыба', 'Ваш шанс избежать Критическое попадание увеличивается на 40% (не работает с Терминатором и Умельцем).'],
