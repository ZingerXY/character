...
var textperk = {
    ...
    PE_TAG: ['Математик', 'Математик', 'Вы все досконально просчитываете. В бою вы получаете +30 к используемому навыку и уменьшаете штраф от дыма на 10, а укрытий на 10. В то же время получая +10 к укрытиям и +10 к дыму когда вы атакованы.'],
	...
	PE_CRITTER: ['Лидер', 'При атаке игрока одиночным выстрелом/ударом, который с вами в одной фракции, тот игрок восстанавливает все од, вместо урона. Не действует на Арройо и не работает в эффекте Цель. Таймауты Доктора должны быть равны нулю. Включает таймауты Доктора на 60 секунд у обоих.'],
