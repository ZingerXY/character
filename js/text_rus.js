...
var texttraits = {
	...
	TRAIT_FINESSE: ['Точность', 'Точно, но не очень быстро. +15 к окончательному урону. Но - +1 ОД к стоимости не прицельных выстрелов.'],
	...
	TRAIT_GOOD_NATURED: ['Добродушие', 'Боевые навыки меньше, а мирные-больше. Вы берете перки каждые 2 уровня, но не можете взять перки на регенерацию, нанесение и поглощение урона. Большинство гуманоидов вас не атакуют, но звери атакуют без задержки.'],
