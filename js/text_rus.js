...
var textperk = {
	...
	PE_SHARPSHOOTER: ['Меткость', 'Искусство попадать в цель с большого расстояния. Вы получаете +2 к Восприятию если оно ниже 3 и +6 к Дальности обзора. Снижает шанс цели увернуться на 5%.'],
