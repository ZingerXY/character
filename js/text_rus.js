...
var textperk = {
	...
	PE_HEALER: ['Лечение', 'Излечение страждущих легче дается вам с этой способностью. Вы получаете +40 ХП бонуса при использовании санитара, и +20 дополнительное если в доп. слоте есть аптечка или докторская сумка.'],
    PE_FORTUNE_FINDER: ['Воодушевление', 'Каждый уворот дает 1 ОД. (Ловкость/2)% к увороту. Если ОЖ меньше трети от максимума, вы не получаете криты.'],
	...
	PE_SNIPER: ['Снайпер', 'Любое попадание в цель из оружия может стать Критическим ударом. Шанс нанести Крит. урон по формуле (УД*4). -1 ОД на прицельный выстрел.'],
	...
	PE_ANIMAL_FRIEND: ['Удачный промах', 'В случае промаха по вам, у вас восстановится 1 ОД. С вероятностью (Харизма+Ловкость+Восприятие)% восстановится количество Од равное точности противника/10.'],
	...
	PE_MUTATE: ['Мутация', 'Радиация пустыни изменила вас! Вы получаете +35 Очков Жизней и +100 очков распределения.'],
	PE_BOOKWORM: ['Регенерация', 'Пассивное восстановление ХП в режиме боя. Тик регенерации 10 секунд. С каждым тиком есть шанс вылечить травму. При -ОД, Од возвращается в 0. +20 Уровень лечения.'],
