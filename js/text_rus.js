...
var textperk = {
    ...
    PE_TAG: ['Математик', 'В бою вы получаете +30 к используемому навыку и уменьшаете штраф от дыма на 10, а укрытий на 10. В то же время получая +10 к укрытиям и +10 к дыму когда вы атакованы.'],
	...
	PE_STOIK: ["Стоик", "При получении летального урона персонаж не умрет и восстановит здоровье по формуле (Уд+Хар)2+Вн3=%. Кд способности 75 секунд. Исключает Фаната."],
	...
	PE_ARMOR: ["Броня", "Дает 120 очков жизни."],
	// << NEW PERK
	...
	// NEW PERK >>
	PE_FISTSANITAR: ["Военврач", "-15 секунд к восстановлению Санитара. Лечение Санитаром как при 10 Удачи."],
	...
	PE_PRICEL: ["Прицел", "Режется штраф дыма (60-дистанция)/2, игнор эффекта Цель."],
	PE_FIRESHOOT: ["Точный расчет", "Вы много тренировались и игнорируете 5% уворота цели. Цель не получает жизни за уворот."],
	// << NEW PERK
