...
var textperk = {
	...
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +8% к Резисту от огня, взрыва и Сопротивляемость урона от нормы на 2 единицы.'],
	...
	PE_ATTACK: ['Неудержимый', 'Вы неудержимы. Получаете +Очков действия (ЛВ/2) и +атлет к урону согласно вашей Ловкости и Восприятию. Нельзя взять Снайпера, Терминатора и Человека Действия.'],
