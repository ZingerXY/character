...
var texttraits = {
	...
	TRAIT_FAST_SHOT: ['Быстрый стрелок', 'Атаки стрелковым и метательным оружием требуют меньше на 1 ОД. Но вы не можете прицельно атаковать, ваш критурон не увеличивается. -50 к используемому боевому навыку.'],
	TRAIT_BLOODY_MESS: ['Маньяк', 'При убийстве игрока вы выходите из боя и получаете +40% от мах ОД. За убийство нпц +3 ОД. Бег в бою после убийства игрока - 3 секунды. Ваша броня и броня ваших жертв ломается в два раза быстрее и в два раза больше поломок при смерти. +125% к навыку Атлетизм'],
	...
	TRAIT_CHEM_RESISTANT: ['Стабильный', 'Ваши попадания, как и промахи, не могут быть критическими. Все ваши атаки очень точны - +35 к навыку при расчете точности, +(Восприятие)% к навыку при расчетах штрафа дыма. Вы стабильно получаете +1 к Восприятию.'],
