...
var texttraits = {
	TRAIT_FAST_METABOLISM: ['Быстрый метаболизм', 'Ваш метаболизм превышает норму. Вам дается +(Харизма*2) к уровню лечения, +8 к силе исцеления суперстимпаков. Устойчивость к яду и радиации в 2 раза меньше. Любое изменение ОД добавит вам 1 жизнь, но только 1 раз за действие'],
	...
	TRAIT_BLOODY_MESS: ['Маньяк', 'Вы получаете +125 к Атлетизму. Бег в бою после убийства игрока - 3 секунды. Износ вашей брони и оружия увеличен в два раза.'],
...
var textperk = {
	...
	PE_ATTACK: ['Неудержимый', 'Вы неудержимы как... Да вас хрен остановишь! Вы получаете +ЛВ/2-1 ОД и +7% к регену ОД. Уберперк.'],
	...
	PE_LUCKDOC: ["Флаг удачи", "С вероятностью Удача% * 1.5% книга или суперстимулятор даст двойной эффект, а тик регена может дать 99 очков жизней, если вы не на глобальной карте."],
