...
var questinfo = {
	imp_battle: ["+%n%% к навыку легкое оружие, +3 к точности.",
				 "+%n%% к навыку тяжелое оружие, +3 к точности.",
				 "+%n%% к навыку энергетическое оружие, +3 к точности.",
				 "+%n%% к навыку метательное оружие, -2 секунды к выход из боя.",
				 "+%n%% к навыку ремонт, +3 к точности.",
				 "+%n%% к навыку рукопашного боя и %r%% холодного оружия, +3 к точности."],
	imp_medical: ["+%n%% к навыку первая помощь, +40 хп при исцелении союзника.",
				  "+3 к увороту, +5ас.", 
				  "+%n%% доктора, +10 хп, +5 к уровню лечения.",
				  "+%n%% доктора, -2 секунды кд на санитар, иммунитет к кровотечению.",
				  "+%n%% к навыку первая помощь, +25 хп при отхиле санитара.",
				  "+15 хп, +%n%% доктора."],
	imp_auxiliary: ["+100кг переносимого веса.", 
					...
					"+%n%% к навыку ловушки, +%r%% к навыку скрытность.",
					"+%n%% к красноречию, перк Репликант.",
					"+%n%% к навыку воровство и взлом, видны нр противника",
					"+%n%% к навыку атлетизм."],
...
var texttraits = {
	TRAIT_FAST_METABOLISM: ['Быстрый метаболизм', 'Ваш метаболизм превышает норму. Вам дается +15 к уровню лечения, +3 к силе исцеления суперстимпаков. Устойчивость к яду и радиации в 2 раза меньше. Любое изменение ОД добавит вам 1 жизнь, но только 1 раз за действие'],
	TRAIT_BRUISER: ['Крушила', 'Двигаетесь помедленнее, но выглядите внушительно. +3 к Силе, +25 к Рукопашным повреждениям. Минусы: -1 ОД.'],
	TRAIT_SMALL_FRAME: ['Xилое тело', 'Вы не в состоянии таскать тяжелые грузы, зато более проворны. Вам дается +1 Ловкость. За каждый уворот +25 ОЖ.'],
	TRAIT_ONE_HANDER: ['Однорукий', 'Вы отлично стреляете из любого одноручного оружия (+60 к навыку при расчетах, +5 к урону и игнорирование штрафа на силу). С двуручным же есть проблемы (-40 к навыку при расчетах).'],
	TRAIT_FINESSE: ['Точность', 'Точно, но не очень быстро. +10% к шансу крита. Выстрел ближе 8 гексов вешает 10% подавления на противника, но не более 30%. Но - +1 ОД к стоимости не прицельных выстрелов.'],
	...
	TRAIT_HEAVY_HANDED: ['Вор', ' +15 к Уровню лечения. Холодное одноручное оружие и метательные ножи наносят +10 конечного урона, но точность другого оружия равна 5%. Бонусы для вора. Вы не можете наносить критические удары.'],
	TRAIT_FAST_SHOT: ['Быстрый стрелок', 'Атаки стрелковым и метательным оружием требуют меньше на 1 ОД. Но вы не можете прицельно атаковать, ваш критурон не увеличивается. При использовании боевого навыка, из него вычитается число равное вашему Уровню (но не более 40).'],
	TRAIT_BLOODY_MESS: ['Маньяк', 'Вы получаете +125 к Атлетизму. При убийстве игрока вы выходите из боя и получаете бег в бою - 3 секунды. Износ вашей брони и оружия увеличен в два раза. При попадании есть шанс обнулить свой кд Санитара с вероятностью Доктор/10%'],
	TRAIT_JINXED: ['Дурной глаз', 'Повышенный шанс критического промаха у вас и ваших жертв. У вас есть 5% шанса, что санитар или СС возымеют двойное действие. 5% шанс что СС не сработает.'],
	TRAIT_GOOD_NATURED: ['Добродушие', 'Боевые навыки меньше, а мирные-больше. Вы берете перки каждые 2 уровня, но не можете взять уберперки. Ваш уворот делится пополам. Большинство гуманоидов вас не атакуют, но звери атакуют без задержки.'],
	TRAIT_CHEM_RELIANT: ['Химик', '+30 ХП, -5 к тикам яда, плазмы и огня. Длительность наркотиков увеличена в 3 раза. Откаты длятся 30 секунд. Шанс получить зависимость увеличен в 2 раза. Зависимость длятся в 3 раза дольше.'],
	TRAIT_CHEM_RESISTANT: ['Стабильный', 'Ваши попадания, как и промахи, не могут быть критическими. Все ваши атаки очень точны - +25 бонуса навыка при расчете точности, Вы стабильно получаете +1 к Восприятию.'],
	TRAIT_SEX_APPEAL: ['Жидкое тело', 'Вы получаете -10 единиц к урону, Максимальный вес +50 кг. Тики огня/2. Лечащие препараты не действуют в полную мощь (-20% при лечении Санитара и -20% при лечении Суперстимулятора).'],
	TRAIT_SKILLED: ['Умелец', 'Вы получаете +25 к антикриту, +15 к шансу крита, +4 параметра к статам, 4-й тагнутый навык и +3 к скиллпоинтам за каждый уровень. Но перки начисляются только после каждого 4 уровня, зато боевой режим при вашей атаке длится 5 секунд. Не можете взять Уберперки.'],
...
var textperk = {
	...
	PE_BONUS_RANGED_DAMAGE: ['Бонус точности', 'Ваши тренировки в обращении со стрелковым оружием сделали свое дело. Выстрелы очередью наносят больше урона +(кол-во пуль+10).'],
	...
	PE_FASTER_HEALING: ['Быстрое лечение', 'Вы получаете + (Харизма * 3) к Уровню лечения, таким образом, ваши раны быстрее заживают. Восстановление 1\4 максимальных ОД при исцелении Санитаром. Использование препаратов на 200мс быстрей.'],
	...
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +2 к трешхолдам, +5% к резистам Нормы и Огня.'],
	...
	PE_SILENT_RUNNING: ['Бесшумный бег', 'Вы двигаетесь быстро, не издавая больше шума. Уберперк'],
	...
	PE_SNIPER: ['Снайпер', 'Шанс нанести Крит увеличивается на 40%. -1 ОД на прицельный выстрел.'],
	...
	PE_DODGER: ['Увертливость', 'Во время боя в вас будет гораздо сложнее попасть. Независимо от одетых на вас в этот момент доспехов, вы получаете +7% к Увороту.'],
	...
	PE_HEAVE_HO: ['Счастливчик', 'При ролле крита по вам добавляется Удача. Попадание в вас с шансом (Удача-Удача противника)% не нанесет урона. Доктором можно восстановить все ОД и ОЖ (шанс Удача%).'],
	...
	PE_FLOWER_CHILD: ['Полевой санитар', 'Восстановление навыка Санитар меньше на 4 секунды. При лечении санитаром добавляются (ИН+УД)*3 дополнительные ОЖ, а также можно восстановить все ОЖ с шансом (Удача*3).'],
	...
	PE_MYSTERIOUS_STRANGER: ['Ветеран', 'Жизненный опыт дает вам +30 ОЖ. Ваша меткость при прицельной атаке максимальная и каждое попадание вешает усталость на цель. В защите вы имеете +10 Класса Брони.'],
	...
	PE_BOOKWORM: ['Регенерация', 'Восстановление ОЖ от Уровня лечения становится полноценным, +35 к Уровню лечения. Лечит конечности во время тика раз в 10 секунд, если персонаж не в бою.'],
	...
	PE_FISTRAGE: ["Критическое мышление", "Каждый выстрел увеличивает на 10% критшанс вплоть до 30%. После выпадении крита он обнуляется."],
	...
	PE_TARGETING: ['Стиляга', "Стиль – ваше второе имя: вы выглядите неотразимо даже в лохмотьях, а вашим солнцезащитным очкам завидуют всё модники пустоши. Иммунитет к черному экрану. Вы никогда не ловите эффект «Контузия» (белый экран). Скорость износа вашей брони замедляется в 4 раза."],
	...
	PE_ARMOR: ['Броня', 'Ваше тело как броня. Вам добавлено 90 очков жизни'],
	PE_PRICEL: ['Гимнаст', 'Занятия гимнастикой и навык воровства позволяют вашим уворотам игнорировать любую атаку, нацеленную на вас кроме погекса, если вы не в укрытии или дыму. Если в укрытии или дыму, увороты работают как обычно.'],
	// << NEW PERK
	PE_ADRENALINE_RUSH: ['Кровопийца', 'Обстоятельно изучив кровь, вы получаете +20 ОЖ. Также каждая атака по цели восстановит (ВС*2) Очков здоровья. При использовании навыка Санитар, вы снимаете с себя эффект Нагрева.'],
	...
	PE_HTH_EVADE: ['Верткость', 'Вы чувствуете, когда надо дернуться с места, природная ловкость помогает вам в этом. Процент Уклонения от атаки увеличивается на Текущие Очки Действия.'],
	PE_KAMA_SUTRA_MASTER: ['Спортсмен', 'Занятия активными видами спорта не прошли даром. Вы получаете +45 Очков Жизней и +20 к Классу Брони.'],
	...
	PE_QUICK_RECOVERY: ['Прыгучесть', 'Вы очень быстро встаете после того, как вас собьют с ног. Реакция и гибкость добавляют вам 1 Очко Действия.'],
	PE_SALESMAN: ['Продажа', 'Вы умеете отлично продавать и покупать. С этой способностью вы на 40% повышаете свой навык Торговля.'],
	PE_STONEWALL: ['Человек-глыба', 'Первая тычка вводящая в бой наносит вдвое меньше урона. Не действует на погекс. +75% шанс игнорировать опрокидывание, Не может выронить оружие/нельзя выбить оружие'],
	...
	// NEW PERK >>
	PE_EXPERT_MEDIC: ["Опытный медик", "При лечении санитара минимум лечения берется как среднее значение первоначального максимума и минимума лечения. Лечение союзника без штрафа."],
	// << NEW PERK
	PE_JINXED_II: ['Старый вояка', 'На своём веку вы повидали многое, и вас так просто не сломить. +32% к антикриту.'],
	...
	PE_IRON_MAN: ['Взрывотехник', 'Переключатели пластида действуют быстрей и есть возможность делать роботов-шахидов (детали робота+пластид).'],
    PE_PRO_UDAR: ['Токсиколог', 'Вы достигли небывалых высот в химии. Оружие с типом урона Норма(кроме очередей) наносит дополнительный урон отравлением.'],
	PE_ADD_ATAC: ['Дополнительные атаки', 'Отдача от оружия никогда не была для вас проблемой. При выстреле с вероятностью в [25+ОД требуемые на выстрел*10]% есть шанс восстановить Очко Действия.'],
	...
	PE_FIRESHOOT: ['Прищур', 'Вы получаете 10% к шансу на крит, восстановление 1 од при прицельном выстреле, исключает Снайпера, Ковбоя и Критическое мышление.'],
	// << NEW PERK
	...
	PE_DERMAL_IMPACT: ['Живчик', 'Вы имеете повышенную живучесть (+35 ОЖ) и природное лечение (+(Харизма * 3) к Уровню лечения).'],
	...
	PE_OFFICER: ['Офицер', 'Вы умеете управлять большим отрядом бойцов. Вы получаете +30 ОЖ, а также точность +5% и срез точности у противника -5%(так же 5% к точности и срезу точности получают и те, кто к вам присоединен). Используется выносливость при расчете группы. Подавление от оружия делится пополам.'],
