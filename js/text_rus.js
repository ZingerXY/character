...
var questinfo = {
	imp_battle: ["+25 единиц к расчетному боевому навыку.",
				 ...
				 "15% шанс выхода из боя при попадании по вам."],
	imp_medical: ["+20% к навыку первая помощь и доктор, +70 хп при исцелении союзника.",
				  "+2 удачи при использовании санитара, +30% к навыку санитар", 
				  "+5 к уровню лечения, +20 ОЖ",
				  "+20% доктора, –2 секунды таймаута санитара, иммунитет к кровотечению",
				  "+20% санитара, +20% доктора, +20 ОЖ",
				  "+40% доктора, +30 хп при лечении Санитаром"],
	...
	imp_bonus:["Рейнджер, +25% к скитальцу",
			   ...
			   "Сапёр: Урон от ловушек не может превышать 50. Урон от самоделок удваивается.",
...
var texttraits = {
	TRAIT_FAST_METABOLISM: ['Быстрый метаболизм', 'Ваш метаболизм превышает норму. За любое изменение ОЖ дается +1 ОЖ. +15нр при исцелении Суперстимпаком. +25 Уровень Лечения. Яд выводится из организма в два раза быстрее. Устойчивость к яду и Устойчивость к радиации уменьшается в три раза.'],
	...
	TRAIT_FINESSE: ['Точность', 'Точно, но не очень быстро. +15% к минимальному и максимальному урону оружия. Но - +1 ОД к стоимости не прицельных выстрелов.'],
	...
	TRAIT_HEAVY_HANDED: ['Вор', 'Холодное одноручное оружие и метательные ножи наносят +10 конечного урона, но точность другого оружия равна 5%. Бонусы для вора кулдаун= 30-(навык/15), срезает 3 ОД у жертвы, если нет Отличника и кидает жертву на пол. Вы не можете наносить критические удары. Исключает атакующие перки (кроме доп рукопашных повреждений), Взрывотехника и Боевого инженера.  Добавляет +15 к Уровню лечения.'],
	...
	TRAIT_SEX_APPEAL: ['Жидкое тело', '-20% к урону от очередей и оружия с типом урона Огонь. +50 к Переносимому грузу. Тики огня/2, но -20% к лечению Санитаром и препаратами. Исключение быстрый метаболизм.'],
...
var textperk = {
	...
	PE_TARGETING: ['Толстокожий', "От типов урона Норма, Взрыв, Электро, Плазма вы получаете на 15% меньше повреждений. Исключение стойкость. "],
