...
var textperk = {
	...
	PE_FASTER_HEALING: ['Быстрое лечение', 'Вы получаете +20 к Уровню лечения, таким образом, ваши раны быстрее заживают. Восстановление 1\4 максимальных ОД при исцелении Санитаром. Стоимость ОД на доктора и санитара на 1 меньше.'],
	...
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +5% Резиста от нормы, +8% к Резисту от Огня и Взрыва. '],
    ...
    PE_MENTAL_BLOCK: ['Стойкость', 'Вы ну прямо очень сильны и устойчивы. Вы получаете +10 ОЖ, +3% к Резисту Нормы, +5% ко всем остальным Резистам. Нельзя взять Отличника или Крутизну.'],
	...
	PE_OFFICER: ['Офицер', 'Вы умеете управлять большим отрядом бойцов. Вы получаете +20 ОЖ, а также срез урона на 5%. Используется выносливость при расчете группы.'],
