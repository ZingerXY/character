...
var texttraits = {
	TRAIT_FAST_METABOLISM: ['Быстрый метаболизм', 'Ваш метаболизм превышает норму. Вам дается +30 к уровню лечения, +15 к силе исцеления суперстимпаков. Устойчивость к яду и радиации в 2 раза меньше.'],
...
var textperk = {
	...
	PE_FASTER_HEALING: ['Быстрое лечение', 'Вы получаете +20 к Уровню лечения, таким образом, ваши раны быстрее заживают. Восстановление 1\4 максимальных ОД при исцелении Санитаром. Использование препаратов на 200мс быстрей.'],
    ...
    PE_FORTUNE_FINDER: ['Воодушевление', 'Каждый Уворот от вражеской атаки прибавляет вам +1 ОД и +25 ОЖ. Увеличивает Уворот на Ловкость%. Если ОЖ меньше трети от максимума, вы не получаете криты.'],
	...
	PE_SILENT_DEATH: ['Хитрость', 'Вы хитры в своих действиях. +25 ОЖ, +5% к Увороту, +50% к Атлетизму. Уходя в сник, вы выходите из боевого режима, при условии, что вы одеты в кожанку (боевая).'],
	...
	PE_GUY:["Крутой парень","Игнорирование требования Силы на дальность метания. Ваша атака по сопернику и атака соперника по вам имеет шанс сжечь ему 3 Од. Сжигание ОД работает на погексовые атаки. Шанс(Порядок>Рандом(0,ПорядокПротивника+100)). Игнор бонусов жертвы на срез урона при атаке в небоевом режиме."],
	PE_BIGSKIN:["Толстокожий","От типов урона норма, взрыв, импульс, плазма вы получаете на 15% меньше повреждений."],
	PE_MASTERMELE:["Мастер ближнего боя","Шанс на атаку с эффектом малая Контузия(без Паники) если атака Рукопашным или Холодным оружием зависит от навыка Скрытность (чем меньше навык, тем выше шанс). Вы блокируете треть урона если атака по вам на расстоянии от 14 гексов"],
	...
	PE_FIRESHOOT: ["Выстрел", "+7 урона, если стреляете одиночным неприцельным выстрелом."],
	// << NEW PERK
	...
	PE_DERMAL_IMPACT: ['Живчик', 'Вы имеете повышенную живучесть (+35 ОЖ) и природное лечение (+20 к Уровню лечения).'],
