...
var textperk = {
	...
	PE_GUY:["Крутой парень","Игнорирование требования Силы на дальность метания. Ваша атака по сопернику и атака соперника по вам имеет шанс сжечь ему 3 Од. Сжигание ОД работает на погексовые атаки. Шанс(Порядок>Рандом(0,ПорядокПротивника+100))."],
