...
var texttraits = {
	...
	TRAIT_FINESSE: ['Точность', '+15% к мах и мин урону оружия. Неприцельный выстрел стоит на 1 ОД дороже.'],
	...
	TRAIT_GOOD_NATURED: ['Добродушие', 'Ваши боевые навыки меньше, но зато небоевые - больше. Вы всегда думаете о защите, а не нападении (-20% урона к очереди или урона огнем. Нельзя взять перки на урон).'],
	...
	TRAIT_CHEM_RESISTANT: ['Стабильный', 'Вы критически не попадаете, но и не промахиваетесь критически. Все ваши атаки очень точны при расчетах попадания +35 в боевой навык. +1 Восприятие.'],
