...
var texttraits = {
	TRAIT_FAST_METABOLISM: ['Быстрый метаболизм', 'Ваш метаболизм превышает норму. Вам дается 40 к уровню лечения +15 HP при исцелении ССками. Яд выводится из организма в два раза быстрее. Устойчивость к яду и радиации в 2 раза меньше. Откаты от СС вдвое сильнее и быстрее.'],
...
var textperk = {
	...
	PE_TOUGHNESS: ['Крутизна', 'Крутизна позволяет чувствовать себя под защитой. Вы получаете +5% Резиста от нормы, +10% к Резисту от Огня и Взрыва. '],
    ...
    PE_FORTUNE_FINDER: ['Воодушевление', 'Дает 5*Харизма ОЖ, каждый уворот дает 1 ОД. Если ОЖ меньше трети от максимума, вы не получаете криты.'],
	...
	PE_MASTER_THIEF: ['Вор-профессионал', '+40% Воровства и Взлома замков. У вас не ломаются отмычки при взломе. Регенерация в снике каждые 10 сек. При взломе 250% можно открывать ящики монтировкой. Не нужна проверка на ловкость и интелект при использовании отмычек'],
