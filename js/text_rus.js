...
var questinfo = {
	...
	imp_bonus:["Рейнджер, +25% к скитальцу",
			   ...
			   "Хомяк: весь ваш лут при смерти падает в инвентарь. Если вас не слутали нпс или враги, вы его сохраняете."],
...
var textperk = {
	...
	PE_FLOWER_CHILD: ['Полевой санитар', 'Восстановление навыка Санитар меньше на 4 секунды. При лечении санитаром с шансом Удача*2% вы полностью восстановите ОЖ.'],
	...
	PE_BOOKWORM: ['Регенерация', 'Восстановление ОЖ от Уровня лечения становится полноценным, +Харизма*3 к Уровню лечения.'],
	...
	PE_LIGHT_STEP: ['Легкие шаги', 'Вы ловки, удачливы и всегда настороже.50%, что ловушка на вас сработает. Урон от ловушек снижен на 50%. +7% к Резисту от Взрыва, +5 к Трешхолду Огня. '],
	...
	PE_DERMAL_IMPACT: ['Живчик', 'Вы имеете повышенную живучесть (+20 ОЖ) и природное лечение (+20 к Уровню лечения).'],
