...
var texttraits = {
	...
	TRAIT_FAST_SHOT: ['Быстрый стрелок', 'Атаки стрелковым и метательным оружием требуют меньше на 1 ОД. Но вы не можете прицельно атаковать, ваш критурон не увеличивается. При использовании боевого навыка, из него вычитается 50 ед.'],
	...
	TRAIT_CHEM_RESISTANT: ['Стабильный', 'Ваши попадания, как и промахи, не могут быть критическими. Все ваши атаки очень точны - +35 бонуса навыка при расчете точности, -Восприятие к штрафу дыма. Вы стабильно получаете +1 к Восприятию.'],
...
var textperk = {
	...
	PE_SNIPER: ['Снайпер', 'Шанс нанести Крит увеличивается на 20%. -1 ОД на прицельный выстрел. Ваша атака вводящая в боевой режим имеет 100% шанс попадания если навык больше 100%. (Удача-Удача цели)% шанс на атаку с бонусным +(5+Удача*2)%(или строго 5%, если в слоте Шлем) урона если у цели сработал Антикрит на вашу критическую атаку.'],
	...
	PE_KAMA_SUTRA_MASTER: ['Спортсмен', 'Занятия активными видами спорта не прошли даром. Вы получаете +33 Очков Жизней и +10 к Классу Брони.'],
