...
var texttraits = {
	TRAIT_FAST_METABOLISM: ['Быстрый метаболизм', 'Ваш метаболизм превышает норму. Вам дается +(Харизма*2) к уровню лечения, +12 к силе исцеления суперстимпаков. Устойчивость к яду и радиации в 2 раза меньше. Любое изменение ОД добавит вам 1 жизнь, но только 1 раз за действие'],
	TRAIT_BRUISER: ['Крушила', 'Двигаетесь помедленнее, но выглядите внушительно. +2 к Силе, +25 к Рукопашным повреждениям. Минусы: -1 ОД.'],
	...
	TRAIT_FINESSE: ['Точность', 'Точно, но не очень быстро. +10% к шансу крита. Но - +1 ОД к стоимости не прицельных выстрелов.'],
	TRAIT_KAMIKAZE: ['Камикадзе', 'Вы прете напролом. +1 Ловкость. Реген 1 ОД раз в 10 секунд. Эффект "Подавление" обнуляется первым тиком. Но Класс брони всегда равен 0.'],
	TRAIT_HEAVY_HANDED: ['Вор', 'Холодное одноручное оружие и метательные ножи наносят +10 конечного урона, но точность другого оружия равна 5%. Бонусы для вора. Вы не можете наносить критические удары. Нельзя взять Бесшумный бег.'],
	...
	TRAIT_BLOODY_MESS: ['Маньяк', 'Вы получаете +125 к Атлетизму. При убийстве игрока вы выходите из боя и получаете +40% от мах ОД. За убийство нпц +3 ОД. Бег в бою после убийства игрока - 3 секунды. Износ вашей брони и оружия увеличен в два раза.'],
	TRAIT_JINXED: ['Дурной глаз', 'Повышенный шанс критического промаха у вас и ваших жертв. 50% шанса, что рана, которую накладывают на вас, по итогу не наложится на вас, а отразится на противника и что ваш уворот превратится в промах противника.  У вас есть 5% шанса, что санитар или СС возымеют двойное действие, но также и 5% шанса'],
	...
	TRAIT_SEX_APPEAL: ['Жидкое тело', 'Вы получаете -10 единиц к урону, Максимальный вес +50 кг. Тики огня/2. Лечащие препараты не действуют в полную мощь (-10% при лечении Санитара и -20% при лечении Суперстимулятора).'],
	...
	TRAIT_NIGHT_PERSON: ['Импульсивный', 'Вы очень активны, и это добавляет вам 1 ОД и 30% шанс восстановить 1 ОД при перезарядке, но вы получаете на 3 Очков Умений меньше за каждый уровень. Также +20% к Метательному. Восстановление ОД во время бега и ходьбы на 25% быстрее.']
}
...
var textperk = {
	...
	PE_HEALER: ['Лечение', 'Вы получаете +40 ОЖ бонуса при использовании санитара, и +20 дополнительное если в доп. слоте есть сумка парамедика. +20 к лечению товарища санитаром или наоборот. +5 к лечению суперстимулятором.'],
	...
	PE_SCROUNGER: ['Полевой медик', 'Вы обладаете огромными знаниями по медицине. +20% к навыку Санитар, +30% к навыку Доктор. +3 Удачи при лечении навыком Санитар. -2 сек. кд. санитара если вы лечите другого или другой вас. Полный отхилл союзника.'],
	...
	PE_BIGSKIN: ["Толстокожий", "От типов урона Норма, Плазма, Электро вы получаете на 15% меньше повреждений. Исключает Железного человека."],
	...
	PE_STOIK: ['Железный человек', 'Урон по вам срезается по формуле (ВЫН+ИНТ+ХАР)*1.5. Не срезается урон от критов. Взаимоисключение с любыми перками на уворот.'],
	PE_CRITTER: ["Концентрация", "Вы получаете -1 очко действия на прицельные выстрелы. Кроме инженерного оружия."],
	PE_TARGETING: ['Стиляга', "Стиль – ваше второе имя: вы выглядите неотразимо даже в лохмотьях, а вашим солнцезащитным очкам завидуют всё модники пустоши. Вы никогда не ловите эффект «Контузия» (белый экран). Скорость износа вашей брони замедляется в 4 раза."],
	...
	PE_DEFENCE: ['Рефлексы', 'Ваши рефлексы повышены и не прицельно вы стреляете быстрее. -1 ОД на неприцельный выстрел (кроме погекса). Нельзя взять Снайпера и Быстрого стрелка. Не работает с инженерным оружием.'],
	PE_ATTACK: ['Неудержимый', 'Вы неудержимы как... Да вас хрен остановишь! Вы получаете +ЛВ/2-1 ОД и +7% к регену ОД. При атаке по цели, вы наносите урон на 10 единиц. Уберперк.'],
	...
	PE_RAGEBER: ['Ярость', 'Яростный удар валит противника на пол, добавляет 8 к урону и снимает 1 ОД. Кд удара 10 секунд.'],
	PE_ARMOR: ['Броня', 'Ваше тело как броня. Вам добавлено 60 очков жизни, -5 к тикам огня, плазмы и яда.'],
	// << NEW PERK
	...
	// NEW PERK >>
	PE_EXPERT_MEDIC: ["Опытный медик", "При лечении санитара минимум лечения берется как среднее значение первоначального максимума и минимума лечения. При расчетах получение Раны к удаче добавляется 5."],
	// << NEW PERK
	...
	// NEW PERK >>
	PE_FISTSANITAR: ['Военврач', 'Лечение Санитаром как при 10 Удачи. С шансом (11-ХаризмаПротивника) вешает эффект Вялость при атаке (только одиночным выстрелом или ударом).'],
	PE_LUCKDOC: ["Флаг удачи", "С вероятностью Удача% книга или суперстимулятор даст двойной эффект, а тик регена может дать 99 очков жизней, если вы не на глобальной карте."],
	PE_PRICEL: ['Прицел', 'Режется штраф дыма (60-дистанция)/2.'],
	...
	PE_DERMAL_IMPACT: ['Живчик', 'Вы имеете повышенную живучесть (+40 ОЖ) и природное лечение (+(Харизма * 3) к Уровню лечения).'],
	...
	PE_OFFICER: ['Офицер', 'Вы умеете управлять большим отрядом бойцов. Вы получаете +30 ОЖ, а также точность +5% и срез урона +5%(так же 5% к точности и срезу урона получают и те, кто к вам присоединен). Используется выносливость при расчете группы. Подавление от оружия делится пополам.'],
