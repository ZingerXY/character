...
var texttraits = {
	TRAIT_FAST_METABOLISM: ["Fast Metabolism", "<font color='#000096'> Pros: </font> You receive +50 hp, +20 to Healing Rate. In non-combat you're regenerating each 10 seconds.</br><font color='#CC0000'> Cons: </font> You're VERY vulnerable to poison and radiation."],
	...
	TRAIT_FINESSE: ["Finesse", "Trade your damage for precious shots.</br><font color='#000096'> Pros: </font> +20% to critical chance. -10 to critroll against you.</br><font color='#CC0000'> Cons: </font> -5% to a total damage."],
	...
	TRAIT_BLOODY_MESS: ["Maniac", "You need to be fast to get precious kills.</br><font color='#000096'> Pros: </font> +175% to Athleticism, Enemies always die in the harshest way.</br><font color='#CC0000'> Cons: </font> -25 to Maximum hitpoints. Both your and enemy's armor deteriorate REAL quick."],
	...
	TRAIT_GOOD_NATURED: ["Good Natured", "<font color='#000096'> Pros: </font> -25% damage from bursts or fire.</br><font color='#CC0000'> Cons: </font> You can't take any offensive perk. You can't apply DoT effects."],
	...
	TRAIT_CHEM_RESISTANT: ["Stable", "<font color='#000096'> Pros: </font> You can't critically miss - at all. All your attacks receive +25 bonus to final Accuracy calculation. +1 to Perception.</br><font color='#CC0000'> Cons: </font> You can't critically hit - at all."],
	TRAIT_SEX_APPEAL: ["Liquid Body", "<font color='#000096'> Pros: </font> You ignore 10 flat damage, maximum Carryweight increases by 50.</br><font color='#CC0000'> Cons: </font> Superstims and First Aid heal are decreased by 20 (ss will become +55, -20 to ending FA heal amount)."],
...
var textperk = {
	...
	PE_FASTER_HEALING: ["Faster Healing", "Rage-N-Eration. You get +10 to Healing Rate. Superstimpacks with this perk will heal for +15 hitpoints."],
	...
	PE_TOUGHNESS: ["Toughness", "If you are tough, you're tough. This Perk adds +2 to Normal DT, +8% resistance to Explosion and Fire damage types. Can't take Durability perk."],
	...
	PE_SHARPSHOOTER: ["Sharpshooter", "You have a talent for hitting things at longer distances. You get a +2 bonus to Perception for accuracy calculations, also +6 Sight Range."],
	...
	PE_HEALER: ["Healer", "You can actually heal something out of people with this Perk. You receive additional +50 hitpoints each time you use FA, also +5 to superstims."],
	PE_FORTUNE_FINDER: ["Twister", "Let's shake like an earthquake! Each successful Evasion heals you for +40 hitpoints and gives 1 AP."],
	PE_BETTER_CRITICALS: ["Better Critical", "The critical hits you inflict in combat are more devastating. You gain (10+Luck)% bonus on the critroll."],
	...
	PE_SILENT_DEATH: ["Foxery", "Nimble like a fox. +25 hp, +5% to Evasion, +50% to Athleticism. When entering a sneak mode, you're leaving combat (if you have Combat Jacket equipped as well)."],
	...
	PE_LIFEGIVER: ["Lifegiver", "You receive additional +65 hitpoints. Long live the Lifegiver!"],
	PE_DODGER: ["Dodger", "You are less likely to be hit by single shots in combat if you have this Perk. You get +5 to your Armor Class and +10% Evasion."],
	PE_SNAKEATER: ["Snakeater", "Yum! Tastes like chicken. For each level of this Perk, you gain +25% to your Poison Resistance."],
	...
	PE_HEAVE_HO: ["Lucky", "When calculating for a critical roll you are additionally added your own Luck (but not more than 10) A single shot or hit on you has a chance (your Luck)% do not inflict damage and destroy 1 coin in inventory (if any) . Applying a doctor with a chance of Luck will restore you all and all AP."],
	...
	PE_ANIMAL_FRIEND: ["Lucky Move", "Dodging (with perks or enemy hitchance higher then 70%) triggers chance to fully restore all APs (Agi+Cha+PE)%. If it didn't, you'll receive 1 AP."],
	...
	PE_BOOKWORM: ["Regeneration", "Each 10 seconds you: restore from KO\KD, have Doctor skill check to heal cripples, regenerate health equal to your Healing Rate in combat. +30 to Healing Rate."],
	...
	PE_ATTACK: ["Expendable", "You're... well, expendable. You receive Agi/2 AP and +(Agi + PE)*2% bonus to Athleticism skill. Incompatible with tons of perks, check wiki. 0% anticrit glasscanon, as it is."],
	PE_HARD: ["Hardened", "Your organism adapted for survival in difficult situations. Your Healing Rate is increased by 5. Can't take Push Up."],
	...
	PE_KAMA_SUTRA_MASTER: ["Sportsman", "Fitness lessons you've learned didn't go to waste. You acquire +40 hitpoints and +8 to Armor Class."],
	...
	PE_STONEWALL: ["Stonewall", "Gives you chance to avoid critical hit - 40% (doesn't stack with Terminator or Skilled trait). 33% chance to avoid KD\KB effects, +5 to Explosion DT."],
	...
	PE_TERMINATOR: ["Terminator", "You don't know anything about knockdowns, blinds or cripples. All critical effects are ignored following this formula: (Str+End)*5."],
	PE_IRON_MAN: ["Iron Man", "You receive less pizduley with this perk."],
	PE_PRO_UDAR: ["Merry Maker", "You're the one who's having fun, for sure. Under alcohol effect you receive "],
	...
	PE_PHOENIX_IMPLANTS: ["РџРѕРґРєРѕР¶РЅР°СЏ Р·Р°С‰РёС‚Р°", "Р’С‹ С‡СѓС‚СЊ СЂРµР¶Рµ РїРѕРґРІРµСЂРіР°РµС‚РµСЃСЊ СѓС‰РµСЂР±Сѓ РѕС‚ СЌРЅРµСЂРіРµС‚РёС‡РµСЃРєРёС… Р°С‚Р°Рє."],
	...
	PE_OFFICER: ["Officer", "Professional yelling at people. You receive +30 hitpoints, and final damage reduce by 5%. End instead of Cha checks for group number."],
