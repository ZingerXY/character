...
var texttraits = {
	TRAIT_FAST_METABOLISM: ["Fast Metabolism", "<font color='#000096'> Pros: </font> You receive +40 to Healing Rate. +15 superstimpack healing bonus. </br><font color='#CC0000'> Cons: </font> Poison are ticking twice as fast. Radiation and Poison resistances from perks, items and drugs are halved. Superstimpacks drawback is two times faster and more powerful."],
	...
	TRAIT_FINESSE: ["Finesse", "Trade your rate of fire for accurate shots.</br><font color='#000096'> Pros: </font> +15% to maximum and minimum weapon damage.</br><font color='#CC0000'> Cons: </font> Unaimed shot costs +1 AP."],
	...
	TRAIT_BLOODY_MESS: ["Maniac", "You need to be fast to get precious kills.</br><font color='#000096'> Pros: </font> Leave combat upon player kill. Receive 6 AP per player kill. Receive 3 AP per NPC kill. </br><font color='#CC0000'> Cons: </font> Both your's and enemy's armor deteriorates twice as fast upon taking damage and upon death. Your weapon deteriorate two times faster."],
...
var textperk = {
	...
	PE_FASTER_HEALING: ["Faster Healing", "Rage-N-Eration. You get +20 to Healing Rate. You receive 1\4 your maximum AP when using First Aid. First Aid and Doctor AP cost reduced by 1."],
	...
	PE_TOUGHNESS: ["Toughness", "If you are tough, you're tough. This Perk adds +5% to Normal DR, +10% to Explosion and Fire DR. Doesn't stack with Durability perk."],
	...
	PE_FORTUNE_FINDER: ["Twister", "Let's shake like an earthquake! Each Dodge gives you +1 AP and +(Charisma*5)HP. If your HP is 33% or lower, you don't receive critical hits."],
	...
	PE_SLAYER: ["Slayer", "All melee attacks (HtH and melee weapons) - are critical (100% chance for a critical damage in close combat)."],
	PE_SNIPER: ["Sniper", "Increases your chance to score a critical hit by (Luck*3). -1 AP for aimed shot."],
	...
	PE_MENTAL_BLOCK: ["Durability", "During your journeys you developed strong and durable body. You receive +25 hitpoints and +3% to Normal, and +5% to the rest Resistances. You can't take Toughness and Excellence."],
