...
var texttraits = {
	...
	TRAIT_FINESSE: ["Finesse", "You like to take your time, then deliver bigger punches.</br><font color='#000096'> Pros: </font> +10% crit chance.</br><font color='#CC0000'> Cons: </font> AP to unaimed shot cost."],
	...
	TRAIT_FAST_SHOT: ["Fast Shot", "You don't have much time to aim.</br><font color='#000096'> Pros: </font> Shooting and throwing costs 1 AP less.</br><font color='#CC0000'> Cons: </font> You can't aim. Your critical damage is always 1x. All your attacks -50%  to skill."],
	TRAIT_BLOODY_MESS: ["Maniac", "+125% to Athleticism. You need to be fast to get precious kills.</br><font color='#000096'> Pros: </font> Leave combat upon player kill. Receive 6 AP per player kill. Receive 3 AP per NPC kill. </br><font color='#CC0000'> Cons: </font> Both your's and enemy's armor deteriorates twice as fast upon taking damage and upon death. Your weapon deteriorate twice as fast."],
...
var textperk = {
	...
	PE_SNIPER: ["Sniper", "Increases your chance to score a critical hit +20%. -1 AP for aimed shot. При одиночном прицельном выстреле может выбить дополнительный урон."],
	...
	PE_ANIMAL_FRIEND: ["Lucky Move", "+1 Очко Действия. -0,2 секунды к восстановлению полоски ОД. (Удача)% шанс восстановить (Точность атакующего/10)ОД при промахе по вам или увороте. Если шанс не выпал вы восстановите 1 ОД."],
	...
	PE_KAMA_SUTRA_MASTER: ["Sportsman", "Fitness lessons you've learned didn't go to waste. You acquire +33 hitpoints and +10 to Armor Class."],
