var traits = {
	...
	// Точность
	// Плюсы: +15 к окончательному урону
	...
	// Минусы: -15 к Легкому, Тяжелому и Энерго -10 к Рукопашке, Холодному и Метательному Мастерперки не действуют. Вы не можете взять перки на урон(плюс и минус) и защиту(резисты)
