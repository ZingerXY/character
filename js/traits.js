var traits = {
	...
	TRAIT_SKILLED: [function(str){	
			...
			},"Умелец", "Параметры персонажа улучшены (+2 ВН, ОБ, ИН, ЛВ, +60 антикрита,+15 к критшансу). Но перки даются - один за каждые четыре уровня и вы не можете взять уберперки."],
	// Импульсивный
